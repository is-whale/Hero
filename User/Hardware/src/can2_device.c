...
//static Pid_Position_t motor_pitch_speed_pid = NEW_POSITION_PID(20, 0, 3, 2000, 50000, 0, 1000, 500);		///< pitch电机速度PID  原来的
static Pid_Position_t motor_pitch_speed_pid = NEW_POSITION_PID( 10, 0, 3,220, 30000, 0, 1000, 500);		///< pitch电机速度PID
